        ...
        <footer className="footer-container">
            ...
            <div className="footer-right">
                ...
                <div className="footer-social-icons">
                    ...
                    <a href="https://twitter.com" className="social-icon twitter-icon" aria-label="Twitter">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 32 32"
                    ...
                    <a href="https://www.instagram.com" className="social-icon instagram-icon" aria-label="Instagram">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 32 32"
