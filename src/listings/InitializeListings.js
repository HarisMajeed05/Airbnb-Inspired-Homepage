...
async function run() {
  try {
    ...
    const collectionAmazingViews = db.collection('amazingviews');
    const collectionCountrySide = db.collection('countryside');
    const collectionTinyHomes = db.collection('tinyhomes');
    ...
    // Insert Rooms data
    await collectionRooms.insertMany(listings['Rooms']);
    console.log('Inserted Rooms data');

    // Insert Top cities data
    await collectionAmazingViews.insertMany(listings['Amazing views']);
    console.log('Inserted Amazing Views data');

    // Insert Top cities data
    await collectionCountrySide.insertMany(listings['CountrySide']);
    console.log('Inserted CountrySide data');

    // Insert Top cities data
    await collectionTinyHomes.insertMany(listings['Tiny homes']);
    console.log('Inserted Tiny Homes data');
  } catch (error) {
